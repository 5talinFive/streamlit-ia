...
logo_image = Image.open("logo-ia.png")  # Imagen del logo junto al título
logo_image = logo_image.resize((70, 70))  # Ajusta el tamaño del logo

user_icon_image = Image.open("icono-user.png")  # Imagen del icono del usuario
user_icon_image = user_icon_image.resize((50, 50))  # Ajusta el tamaño del icono del usuario

bot_icon_image = Image.open("logo-ia.png")  # Imagen del icono de RASGAEL
